...
const BOOSTER_DESCRIPTIONS: Record<BoosterType, string> = {
	CLASSIC:
		"A classic booster pack containing 7 cards with different rarities. Each pack contains at least 1 rare card and has a chance to contain epic and legendary cards.",
};
	...
	return (
		<StyledSection>
			<BoosterShopContainer>
				...
				<BoosterList>
					...
					>
						...
						<BoosterCount>{unopenedBoosters.length} available</BoosterCount>
					</BoosterCard>
							...
							<BoosterList>
								{unopenedBoosters.map((booster) => (
									...
									>
										...
										<BoosterName>
											{booster.type.charAt(0) +
												booster.type.slice(1).toLowerCase()}
										</BoosterName>
									</BoosterCard>
								))}
							</BoosterList>
			...
			>
				<div style={{ padding: "20px", textAlign: "center" }}>
					<h3>
						You have {cardCollection.cards.length} cards in your collection
					</h3>
					<div
						style={{
							display: "flex",
